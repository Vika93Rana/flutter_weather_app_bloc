      ...
      body: BlocBuilder<WeatherBloc, WeatherState>(
        builder: (context, state) {
          ...
          if(state is WeatherFailure){
            /// bloc can detect the state that is why it can
            /// give the error property from WeatherFailure without typecasting
          ...
          /// bloc can detect the state that is why it can
          /// give the model property from WeatherFailure without typecasting
